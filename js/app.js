...
$(document).click(function(){
  if($("#mce-EMAIL").hasClass("mce_inline_error")) {
    ...
    $(".mc-field-group").html("<!--      <label for="mce-EMAIL">Email</label> --> <input type="email" placeholder="Email" value="" name="EMAIL" class="required email mce_inline_error" id="mce-EMAIL" aria-required="true" aria-invalid="true">");
  } else {
